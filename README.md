...
- [ ] Phase 1: 애플리케이션 골격 구축 (타입 정의, 라우트 구조, Notion 클라이언트)
- [ ] Phase 2: UI/UX 완성 (더미 데이터 기반 모든 페이지 구현)
- [ ] Phase 3: Notion API 실제 연동 + 카카오 지도 마커/팝업 구현
- [ ] Phase 4: 다크모드, 성능 최적화, Vercel 배포
