...
- ⬜ **Task 024-A: PATCH /api/places/[placeId] Route Handler 구현 (F024)**
...
- ⬜ **Task 024-B: EditPlaceDialog 컴포넌트 구현 (F024)**
...
- ⬜ **Task 024-C: PlaceCard 수정 버튼 추가 및 E2E 테스트 (F024)**
  - `components/travel/PlaceCard.tsx` 수정
